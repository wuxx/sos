...
enum {
    ...
    CORETIMER_BASE = 0x2000B000,
        CORETMLOAD  = (CORETIMER_BASE + 0x400),
        CORETMVAL   = (CORETIMER_BASE + 0x404),
        CORETMCTRL  = (CORETIMER_BASE + 0x408),
        CORETMCLR   = (CORETIMER_BASE + 0x40C),
        CORETMRAW   = (CORETIMER_BASE + 0x410),
        CORETMMSK   = (CORETIMER_BASE + 0x414),
        CORETMRELD  = (CORETIMER_BASE + 0x418),
        CORETMPRED  = (CORETIMER_BASE + 0x41C),
        CORETMFRC   = (CORETIMER_BASE + 0x420),
