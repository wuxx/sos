...
enum {
    ...
    VIC_BASE = 0x2000B200,
        IRQ_PEND_BASIC    = (VIC_BASE + 0x00),
        IRQ_PEND1         = (VIC_BASE + 0x04),
        IRQ_PEND2         = (VIC_BASE + 0x08),
        FIQ_CTRL          = (VIC_BASE + 0x0C),
        IRQ_ENABLE1       = (VIC_BASE + 0x10),
        IRQ_ENABLE2       = (VIC_BASE + 0x14),
        IRQ_ENABLE_BASIC  = (VIC_BASE + 0x18),
        IRQ_DISABLE1      = (VIC_BASE + 0x1C),
        IRQ_DISABLE2      = (VIC_BASE + 0x20),
        IRQ_DISABLE_BASIC = (VIC_BASE + 0x24),
